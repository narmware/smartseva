...
public class ServiceElectricAdapter extends RecyclerView.Adapter<ServiceElectricAdapter.MyViewHolder> {
        ...
        public MyViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                   ...
                   // Toast.makeText(mContext, mItem.getMain_service_id()+"", Toast.LENGTH_SHORT).show();

                    showPriceDialog(mItem.getSer_name(),mItem.getSer_img_url());
    ...
    public ServiceElectricAdapter(Context context, List<SubServices> services, FragmentManager fragmentManager) {
