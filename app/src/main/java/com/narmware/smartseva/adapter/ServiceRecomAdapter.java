...
public class ServiceRecomAdapter extends RecyclerView.Adapter<ServiceRecomAdapter.MyViewHolder> {
    ...
    public ServiceRecomAdapter(Context context, List<SubServices> services, FragmentManager fragmentManager) {
