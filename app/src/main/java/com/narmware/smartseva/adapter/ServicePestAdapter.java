...
public class ServicePestAdapter extends RecyclerView.Adapter<ServicePestAdapter.MyViewHolder> {
    ...
    public ServicePestAdapter(Context context, List<SubServices> services, FragmentManager fragmentManager) {
